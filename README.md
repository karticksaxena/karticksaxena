...
- 📉 **[Medium Churn Pipeline](https://github.com/karticksaxena/Medium-Churn)** - Production-style ML retraining pipeline with Kubeflow, BigQuery ML (XGBoost), and Vertex AI for churn prediction
